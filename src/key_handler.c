...
/*   Updated: 2025/06/09 20:24:44 by jukerste         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx_image_to_window(game->mlx, game->img_floor, game->player_x * TILE_SIZE,
		game->player_y * TILE_SIZE);
	mlx_image_to_window(game->mlx, game->img_player, new_x * TILE_SIZE,
		new_y * TILE_SIZE);
